(
    function (){
        ...
        console.log("Random number: "+ random +" == 2 is " + isTwo(random))
        /**
         * TODO:
         ...
         */
        function calculateTip(percent, totalBill){
            return percent * totalBill;
        }
        console.log("Tip: $" + calculateTip(0.20, 20));
        console.log("Tip: $" + calculateTip(0.25, 25.50));
        console.log("Tip: $" + calculateTip(0.15, 33.42));
        /**
         * TODO:
        ...
        console.log("Price after discount: " + applyDiscount(100, 0.2))
