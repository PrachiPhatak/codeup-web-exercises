(function() {
    ...
    shoppers.forEach(shopper => printDiscount(shopper));

    function printDiscount(shopper){
        let discount = 0;
        if(shopper.amount >= 200){
            discount = shopper.amount * 0.12;
        }

        console.log(`${shopper.name}'s bill`);
     ...
     */
    let books =[
        {title:"The Salmon of Doubt", author:{firstName: "Prachi",lastName: "Phatak"}},
        {title:"Douglas", author:{firstName: "Shreya",lastName: "Kulkarni"}},
        {title:"Adams", author:{firstName: "Aarya",lastName: "Kul"}},
        {title:"Mindset", author: {firstName: "Carol", lastName: "Dweck"}},
